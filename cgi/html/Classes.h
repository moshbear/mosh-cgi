...
#ifndef _CGI_HTML_CLASSES_H_
#define _CGI_HTML_CLASSES_H_ 1
...
#include <cgi/html/AtomicElement.h>
#include <cgi/html/BooleanElement.h>
...
#define ATOMIC_ELEMENT(name, tag) \
	TAG(name, tag); \
	template <class charT> class name : public AtomicElement<charT, name##Tag > { }
...
#define BOOLEAN_ELEMENT(name, tag) \
	TAG(name, tag); \
	template <class charT> class name : public BooleanElement<charT, name##Tag > { }
...
class comment: public BooleanElement<charT,nullTag> {
