//! @file mosh/cgi/html/html_doctype.hpp HTML DTD Declaration
/* 
...
#ifndef MOSH_CGI_HTML_HTML_DOCTYPE_HPP
#define MOSH_CGI_HTML_HTML_DOCTYPE_HPP

#include <string>
#include <cstdint>
#include <mosh/cgi/html/sgml_doctype.hpp>
