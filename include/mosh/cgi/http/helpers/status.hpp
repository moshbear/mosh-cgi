//! @file mosh/cgi/http/helpers/status.hpp String lookup for HTTP status codes
/* 
...
#ifndef MOSH_CGI_HTTP_HELPERS_STATUS_HPP
#define MOSH_CGI_HTTP_HELPERS_STATUS_HPP
