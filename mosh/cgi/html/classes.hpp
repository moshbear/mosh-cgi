//! @file mosh/cgi/html/classes.hpp The header file containing HTML output classes
/*
...
#ifndef MOSH_CGI_HTML_CLASSES_HPP
#define MOSH_CGI_HTML_CLASSES_HPP

#include <string>
#include <boost/lexical_cast.hpp>
#include <mosh/cgi/html/element/atomic.hpp>
#include <mosh/cgi/html/element/boolean.hpp>
...
#define TAG(name, tag) \
	class name##Tag { \
		public: inline static const char* name() { return (tag);}; \
	}
...
#define ATOMIC_ELEMENT(name, tag) \
	TAG(name, tag); \
	template <class charT> class name : public element::Atomic<charT, name##Tag > { }
...
#define BOOLEAN_ELEMENT(name, tag) \
	TAG(name, tag); \
	template <class charT> class name : public element::Boolean<charT, name##Tag > { }
...
/*! @class comment HTMLClasses.h cgi/HTMLClasses.h
 * @brief An HTML comment
 */
template <class charT>
class comment: public element::Boolean<charT,nullTag> {
...
#undef TAG
#undef ATOMIC_ELEMENT
#undef BOOLEAN_ELEMENT
